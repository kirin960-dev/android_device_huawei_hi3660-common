...
#define LOG_TAG "vendor.lineage.touch@1.0-service.hi3660"
...
using ::vendor::lineage::touch::V1_0::hi3660::GloveMode;
using ::vendor::lineage::touch::V1_0::IKeyDisabler;
using ::vendor::lineage::touch::V1_0::hi3660::KeyDisabler;
